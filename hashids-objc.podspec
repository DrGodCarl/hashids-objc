#
#  Be sure to run `pod spec lint hashids-objc.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Carl D. Benson"
  # s.authors            = { "Carl D. Benson" => "carl.d.benson@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Carl D. Benson"
  ...
  s.source_files  = "Hashids", "Hashids/**/*.{h,m}"
